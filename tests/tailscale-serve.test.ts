/**
 * Where Tailscale fronts the relay (`src/tailscale.ts` ▸ `relayServeState`), read off saved
...
import { freeServePort, parseServeStatus, relayServeState, serveUrl } from '../src/tailscale.ts'
